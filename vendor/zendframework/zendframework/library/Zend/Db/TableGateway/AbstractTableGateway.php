...
abstract class AbstractTableGateway implements TableGatewayInterface
{
    ...
    public function initialize()
    {
        ...
        if (!is_string($this->dbTable) && !$this->dbTable instanceof TableIdentifier) {
        ...
        if (!$this->sql instanceof Sql) {
            $this->sql = new Sql($this->adapter, $this->dbTable);
        }
     ...
     * @return string
     */
    public function protoTypeToClass()
    {
        return $this->dbTable;
    }
    ...
    protected function executeSelect(Select $select)
    {
        ...
        if ($selectState['table'] != $this->dbTable) {
    ...
    protected function executeInsert(Insert $insert)
    {
        ...
        if ($insertState['table'] != $this->dbTable) {
    ...
    protected function executeUpdate(Update $update)
    {
        ...
        if ($updateState['table'] != $this->dbTable) {
    ...
    protected function executeDelete(Delete $delete)
    {
        ...
        if ($deleteState['table'] != $this->dbTable) {
            throw new Exception\RuntimeException('The table name of the provided Update object must match that of the table');
        }
    ...
    public function __clone()
    {
        ...
        if (is_object($this->dbTable)) {
            $this->dbTable = clone $this->dbTable;
        }
    }
